<template>
  ...
  >
    ...
    <div class="mt-3 pt-3 border-t border-gray-100
                flex flex-wrap gap-1.5 text-xs text-stone-500">

      <span v-if="countryName" class="rounded-full bg-stone-100 px-2.5 py-0.5 font-medium">
        {{ countryName }}
      </span>

      <span v-if="locality.elevation" class="rounded-full bg-stone-100 px-2.5 py-0.5">
        {{ locality.elevation }} m elevation
      </span>

      <span v-if="locality.depth" class="rounded-full bg-stone-100 px-2.5 py-0.5">
        {{ locality.depth }} m depth
      </span>

      <span v-if="locality.latitude && locality.longitude" class="rounded-full bg-stone-100 px-2.5 py-0.5">
        Has coordinates
      </span>
